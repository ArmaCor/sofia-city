...
class Voice {
  ...
  /** onDone — вызвать, когда все файлы разблокированы. Важно дождаться
   *  конца, а не запускать первую реальную реплику параллельно: иначе
   *  разблокировка того же файла может поставить его на паузу и обнулить
   *  ровно в момент, когда он должен зазвучать по-настоящему — отсюда
   *  была полная тишина на самом первом «Привет, София!». */
