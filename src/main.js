...
ui.btnStart.addEventListener('click', () => {
  ...
  // Сначала разблокируем ВСЕ звуковые файлы (по одному, друг за другом),
  // и только когда это точно закончилось — говорим первую реплику.
  // Если запустить их параллельно, разблокировка того же файла может
  // погасить его звук ровно в момент настоящего проигрывания.
  voice.unlockAudioFiles(() => {
